...
class AllocaInstruction : public Instruction {//分配地址
public:
...
class LoadInstruction : public Instruction {//加载
public:
...
class StoreInstruction : public Instruction {//存储
public:
...
class BinaryInstruction : public Instruction {//表达式
public:
...
class CmpInstruction : public Instruction {//比较
public:
